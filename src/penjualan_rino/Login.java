...
public class Login extends javax.swing.JFrame {
    ...
    private void rSMaterialButtonRectangle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonRectangle2ActionPerformed
       ...
       String password = String.valueOf(tpass.getPassword()); // Membaca password tersembunyi dengan aman

        if(username.equals("admin") && password.equals("12345")){
            JOptionPane.showMessageDialog(this, "Login Berhasil!");

            // 1. Simpan session ID Kasir ke Class UserID
            UserID.setUserLogin("TOKO_RINO");

            // 2. Alihkan navigasi langsung ke Menu Utama
